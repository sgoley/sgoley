...
- 💾 My primary coding language these days is [python](https://www.python.org)🐍 but continuously looking to improve as I learn more about [Ruby](https://www.ruby-lang.org/en/)💎,  javascript via [next.js](https://nextjs.org), solidity via [foundry](https://getfoundry.sh), and more.
